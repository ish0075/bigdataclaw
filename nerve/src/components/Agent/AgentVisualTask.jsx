...
const AGENT_VISUALS = {
  ...
  // Star Office real agents
  'agent_ceo':           { theme: 'target',   label: 'Strategic oversight' },
  'agent_gemma4':        { theme: 'nodes',    label: 'Scientific analysis' },
  'agent_kimi':          { theme: 'typing',   label: 'Coding & research' },
  'agent_ace':           { theme: 'waves',    label: 'Marketing outreach' },
  'agent_alex':          { theme: 'search',   label: 'Agent recruitment' },
  'agent_hunter':        { theme: 'radar',    label: 'Deal hunting' },
  'agent_ambassador':    { theme: 'chat',     label: 'Community relations' },
  'agent_echo':          { theme: 'bars',     label: 'Property analytics' },
  'agent_appraisal':     { theme: 'dial',     label: 'Valuation analysis' },
  'agent_buyerscout':    { theme: 'search',   label: 'Buyer prospecting' },
  'agent_buzz':          { theme: 'waves',    label: 'Social buzz' },
  'agent_codebuilder':   { theme: 'typing',   label: 'Building code' },
  'agent_contentbot':    { theme: 'typing',   label: 'Creating content' },
  'agent_contexkeepsync':{ theme: 'sync',     label: 'Syncing memory' },
  'agent_dataminer':     { theme: 'bars',     label: 'Mining data' },
  'agent_factchecker':   { theme: 'verify',   label: 'Fact checking' },
  'agent_legalcompliance':{ theme: 'shield',  label: 'Compliance review' },
  'agent_lens':          { theme: 'search',   label: 'Market insights' },
  'agent_maven':         { theme: 'nodes',    label: 'Knowledge hub' },
  'agent_obsidiansync':  { theme: 'sync',     label: 'Vault sync' },
  'agent_openclaw':      { theme: 'chat',     label: 'Knowledge librarian' },
  'agent_propertyscout': { theme: 'radar',    label: 'Scouting properties' },
  'agent_scribe':        { theme: 'typing',   label: 'Documenting' },
  'agent_sellerprofile': { theme: 'search',   label: 'Profiling sellers' },
  'agent_spark':         { theme: 'sparkles', label: 'Ideating' },
  'agent_stage':         { theme: 'grid',     label: 'Staging presentation' },
  'agent_testrunner':    { theme: 'checklist',label: 'Running QA' },
  'agent_webscout':      { theme: 'radar',    label: 'Web scouting' },
  'star':                { theme: 'sparkles', label: 'On standby' },
