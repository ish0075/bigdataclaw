      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 mt-1">
            {stats ? `${stats.total_flagged.toLocaleString()} high-priority deals surfaced from Ontario transaction and land-registry intelligence` : 'Loading opportunities...'}
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-start gap-4">
          <div className="flex-1">
            ...
            <p className="text-slate-300 text-sm leading-relaxed">
              This is your <strong>Opportunity Command Center</strong>. It monitors Ontario commercial real estate transactions and land-registry intelligence to surface two working pipelines:
              <span className="text-accent-yellow font-medium"> capital-rich acquisition opportunities</span> in Goldmine and
              <span className="text-red-400 font-medium"> financially stressed properties</span> in Distressed.
            </p>
          </div>
          <div className="flex-1">
            <h3 className="text-white font-semibold mb-2 flex items-center gap-2">
            ...
            <ul className="text-slate-300 text-sm space-y-1">
              <li className="flex items-start gap-2">
                ...
                <span><strong>Goldmine tab:</strong> Review recent capital movements, cash-heavy buyers, and larger transactions by asset class, urgency, and price range.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-red-400">2.</span>
                <span><strong>Distressed tab:</strong> Review properties flagged for financial stress, including leverage pressure, costly debt, upcoming renewals, and negative equity risk.</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-400">3.</span>
                <span>Open any result to review the signal, then move directly into outreach, referral, or underwriting workflow.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-slate-400 mt-1 max-w-3xl">
              Properties showing signs of financial stress based on Ontario land-registry intelligence, including mortgage renewals, high leverage, demand loans, and potential negative equity.
            </p>
          </div>
          ...
          <div className="bg-slate-800/40 rounded-xl border border-slate-700/50 p-8 text-center">
            {distressedLoading ? (
              <>
                ...
                <p className="text-slate-500 text-sm mt-1">Querying the BigDataClaw distress scanner</p>
              </>
            ) : distressedError ? (
              <>
                <AlertCircle className="w-10 h-10 text-orange-500 mx-auto mb-4" />
                <p className="text-slate-300 font-medium">Distress scanner not available</p>
              ...
              <>
                ...
                <p className="text-slate-500 text-sm mt-2 max-w-lg mx-auto">
                  These reports are generated from the BigDataClaw flagged-opportunity scanner. Live distress findings will appear here as the scanner publishes them.
                </p>
              </>
            ) : (
